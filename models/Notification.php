...
class Notification {
    ...
    // NOUVEAU : Alias pour front (JS utilise description)
    public function getDescription(): string { return $this->message; }
    public function setDescription(string $v): void { $this->setMessage($v); }
